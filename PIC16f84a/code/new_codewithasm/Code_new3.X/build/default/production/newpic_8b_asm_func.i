...
main:
  ...
  X EQU 31h
  BSF STATUS,5
         bsf TRISA,0 ;set ((PORTA) and 07Fh), 0 as input
  bsf TRISA,1 ;set ((PORTA) and 07Fh), 0 as input
  bsf TRISA,2 ;set ((PORTA) and 07Fh), 0 as input
  bsf TRISA,3 ;set ((PORTA) and 07Fh), 0 as input
  bsf TRISA,4 ;set ((PORTA) and 07Fh), 0 as input
  bsf TRISA,5 ;set ((PORTA) and 07Fh), 0 as input

  bcf TRISB,0 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,1 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,2 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,3 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,7 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,6 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,5 ;set ((PORTB) and 07Fh), 7 as output
         bcf TRISB,4 ;set ((PORTB) and 07Fh), 7 as output
